...
// File contracts/BooztoryToken.sol
 ...
 */
contract BooztoryToken is ERC20, Ownable {

    // -------------------------------------------------------------------------
    // State
    // -------------------------------------------------------------------------

    /// @notice When true, all transfers are blocked (mint & burn still work).
    ...
    /**
     * @param _booztory  Address of the deployed Booztory.sol contract.
     */
    constructor(address _booztory)
        ERC20("BooztoryToken", "BOOZ")
        Ownable(msg.sender)
    {
     ...
     *         Can only be called once. Owner decides the amount.
