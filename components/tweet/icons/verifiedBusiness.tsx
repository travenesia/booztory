export const VerifiedBusinessIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 22 22" aria-label="Verified business account" role="img" className={className}>
    <g>
      <linearGradient
        gradientUnits="userSpaceOnUse"
        id="verified-business-a"
        x1="4.411"
        x2="18.083"
        y1="2.495"
        y2="21.508"
