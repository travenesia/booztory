export const VerifiedGovernmentIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 22 22"
    aria-label="Verified government account"
    role="img"
    className={className}
    fill="currentColor" // Assuming the grey color comes from the parent's text color
  >
    <g>
      <path
        clipRule="evenodd"
